...
function keyPressed(e) {
	if (e.code == 'KeyA') {
		c1Note.currentTime = 0;
		c1Audio.play();
		document.getElementById('c1').style.backgroundColor = '#db1d2d';
	}
	if (e.code == 'KeyS') {
		dNote.currentTime = 0;
		dAudio.play();
		document.getElementById('d').style.backgroundColor = '#f0421c';
	}
	if (e.code == 'KeyD') {
		eNote.currentTime = 0;
		eAudio.play();
		document.getElementById('e').style.backgroundColor = '#fec02d';
	}
	if (e.code == 'KeyF') {
		fNote.currentTime = 0;
		fAudio.play();
		document.getElementById('f').style.backgroundColor = '#20d071';
	}
	if (e.code == 'KeyG') {
		gNote.currentTime = 0;
		gAudio.play();
...
function keyUnpressed(e) {
	if (e.code == 'KeyA') {
		document.getElementById('c1').style.backgroundColor = '#3e181b';
	}
	if (e.code == 'KeyS') {
		document.getElementById('d').style.backgroundColor = '#422018';
	}
	if (e.code == 'KeyD') {
		document.getElementById('e').style.backgroundColor = '#45391b';
	}
	if (e.code == 'KeyF') {
		document.getElementById('f').style.backgroundColor = '#193c29';
	}
	if (e.code == 'KeyG') {
